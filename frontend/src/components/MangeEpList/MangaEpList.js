    ...
    return(
        <div class="grid grid-rows-2 grid-col-5">
                ...
                <div className="row-start-1 row-end-1 px-2 py-2">
                        ...
                        <figure><img src={loveiswar} alt="anime" className=" rounded-lg box-content h-80 w-64 border-4"/></figure>
                        
                    
                </div>
                <div class="col-start-2 col-end-6 row-start-1 row-end-1 bg-secondary">
                    <h1 className="text-3xl font-bold">Love is War</h1>
                    
                    <h2 className="text-2xl italic underline">Sinapsis</h2>
                    <p>Two geniuses develop over the top and clever schemes to try and get the other to confess their love first, because to them, love is war</p>
                </div>
        <div className="overflow-y-auto col-start-2 col-end-5 row-end-3 h-80 w-120">
            <table className="table w-full">
                ...
                <tbody>
                    <tr>
                        <a href="/MangaLec" className="hover:text-warning">
                            <th>
                            ...
                            <td>Episode 1</td>
                            <td>I Want to be Invited to a Movie</td>
                            <td></td>
                        </a>
                    </tr>
